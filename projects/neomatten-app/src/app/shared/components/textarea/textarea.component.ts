/*
 * EN: Multi-line text input for the shared UI kit. Implements ControlValueAccessor
 *     so it works with Reactive Forms (formControlName), renders an optional label
 *     and a localized validation error, and styles itself on the brand palette.
 * RU: Многострочный ввод общего UI-кита. Реализует ControlValueAccessor для работы
 *     с Reactive Forms (formControlName), отображает необязательную метку и
...
export class TextareaComponent implements ControlValueAccessor, OnInit {
  ...
  readonly inputId = input<string>(`nm-textarea-${uniqueId++}`);
