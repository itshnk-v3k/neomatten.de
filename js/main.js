...
function openInfo(titleDe, titleEn, textDe, textEn) {
  ...
  if (!pop) {
    ...
    pop
      ...
      .addEventListener("click", () => pop.classList.remove("open"));
  }
  const t = document.getElementById("infoPopTitle");
  const x = document.getElementById("infoPopText");
  t.dataset.de = titleDe;
  t.dataset.en = titleEn;
  x.dataset.de = textDe;
  x.dataset.en = textEn;
...
function bindPopupDismiss() {
  ...
  document.addEventListener("keydown", (e) => {
    if (e.key === "Escape") {
      document
        .querySelectorAll(
          ".popup-overlay.open, .popup-discount.open, .info-pop.open",
        )
...
const faqData = [
  {
    de: [
      "Wie lange ist die Garantie auf die Matten?",
      "Auf das Material gewähren wir 1 Jahr garantierte Lebensdauer.",
    ],
    en: [
      "How long is the warranty?",
      "We provide a guaranteed lifespan of 1 year on the material.",
    ],
  },
  {
    de: [
      "Was tun, wenn die Matten nicht passen?",
      "Innerhalb von 14 Tagen ist ein Umtausch bei Nichtübereinstimmung möglich.",
    ],
    en: [
      "What if the mats don't fit?",
      "An exchange is possible within 14 days in case of mismatch.",
    ],
  },
  {
    de: [
      "Wie lange halten die Matten?",
      "Bei normaler Nutzung viele Jahre — das Material ist äußerst langlebig.",
    ],
    en: [
      "How long do the mats last?",
      "Many years under normal use — the material is extremely durable.",
    ],
  },
  {
    de: [
      "Wie werden die Matten befestigt?",
      "Mit Original-Clips und einem zusätzlichen Klettsystem.",
    ],
    en: [
      "How are the mats attached?",
      "With original clips and an additional hook-and-loop system.",
    ],
  },
  {
    de: [
      "Riechen die Matten?",
      "Nein. Das zertifizierte EVA-Material ist geruchsneutral.",
    ],
    en: [
      "Do the mats have an odour?",
      "No. The certified EVA material is odour-neutral.",
    ],
  },
  {
    de: [
      "Ist EVA-Material hypoallergen?",
      "Ja, EVA ist hypoallergen und für Innenräume unbedenklich.",
    ],
    en: [
      "Is EVA hypoallergenic?",
      "Yes, EVA is hypoallergenic and safe for interiors.",
    ],
  },
  {
    de: [
      "Wie widerstandsfähig ist das Material?",
      "Sehr — es widersteht ±50 °C, Feuchtigkeit und Abrieb.",
    ],
    en: [
      "How durable is the material?",
      "Very — it resists ±50 °C, moisture and abrasion.",
    ],
  },
];
