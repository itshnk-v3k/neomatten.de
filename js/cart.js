...
const LABELS = {
  ...
  set: {
    "vorne-rechts": "Vorderer rechts",
    "vorne-links": "Vorderer links",
    "vorne-paar": "Vorderes Paar",
    "hinten-rechts": "Hinterer rechts",
    "hinten-links": "Hinterer links",
    "hinten-paar": "Hinteres Paar",
    voll: "Vollständiges Set",
    premium: "Premium-Set",
  },
...
function showCartToast(name) {
  ...
  t.textContent =
    (en ? "✓ Added to cart: " : "✓ Zum Warenkorb: ") + (name || "");
