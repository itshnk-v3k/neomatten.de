...
const MODELS_BY_BRAND = {
  Audi: [
    ["A3 Sportback 2012–2020", "AU12301"],
    ["A4 (B9) 2015–2023", "AU15604"],
    ["A6 (C8) 2018–2024", "AU18807"],
    ["A7 (4G7) Liftback 2010–2017", "AU23725"],
    ["Q5 (FY) SUV 2017–2024", "AU20905"],
    ["Q7 (4M) SUV 2015–2024", "AU20907"],
  ],
  BMW: [
    ["3er (G20) 2018–2024", "BM32001"],
    ["5er (G30) 2017–2023", "BM53002"],
    ["X3 (G01) SUV 2017–2024", "BMX3017"],
    ["X5 (G05) SUV 2018–2024", "BMX5018"],
  ],
  Mercedes: [
    ["C-Klasse (W205) 2014–2021", "MB20514"],
    ["E-Klasse (W213) 2016–2023", "MB21316"],
    ["GLC (X253) 2015–2022", "MBGLC15"],
  ],
  Volkswagen: [
    ["Golf VII 2012–2019", "VW07012"],
    ["Golf VIII 2019–2024", "VW08019"],
    ["Passat (B8) 2014–2023", "VWPB814"],
    ["Tiguan II 2016–2024", "VWTG216"],
  ],
  Toyota: [
    ["Camry XV70 2017–2024", "TOCXV70"],
    ["Corolla E210 2018–2024", "TOE2108"],
    ["RAV4 V 2018–2024", "TORAV45"],
  ],
  Hyundai: [
    ["Tucson III 2015–2020", "HYTU315"],
    ["Tucson IV 2020–2024", "HYTU420"],
    ["Santa Fe 2018–2024", "HYSF018"],
  ],
  KIA: [
    ["Sportage IV 2015–2021", "KISP415"],
    ["Ceed III 2018–2024", "KICE318"],
    ["Sorento IV 2020–2024", "KISO420"],
  ],
  Skoda: [
    ["Octavia III 2012–2020", "SKOC312"],
    ["Octavia IV 2019–2024", "SKOC419"],
    ["Kodiaq 2016–2024", "SKKD016"],
  ],
  Porsche: [
    ["Macan 2014–2024", "POMAC14"],
    ["Cayenne 2017–2024", "POCAY17"],
    ["Panamera 2016–2024", "POPAN16"],
  ],
  Ford: [
    ["Focus IV 2018–2024", "FOFC418"],
    ["Kuga III 2019–2024", "FOKG319"],
    ["Mondeo V 2014–2022", "FOMD514"],
  ],
};
...
function filterModels() {
  ...
  if (modelSel)
    list = list.filter((m) =>
      m[0].toLowerCase().includes(modelSel.toLowerCase()),
    );
...
function initCatalog() {
  ...
  if (cat === "mats" && brand) {
    ...
    if (mf) {
      mf.innerHTML =
        '<option value="">' +
        (typeof isEnglish === "function" && isEnglish()
          ? "Select model"
          : "Modell auswählen") +
        "</option>" +
        [...new Set(CURRENT_MODELS.map((m) => m[0].split(" ")[0]))]
